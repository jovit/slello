...
class ProjectInfo_3 extends React.Component {
  ...
  render() {
    return (
      <div className="center-component-container">
          ...
          <img width="90%" src="img/timeline3.png" alt=""/>
          ...
          <Table style={{fontSize: 16}} celled padded collapsing>
            ...
            <Table.Body>
              <Table.Row>
                ...
                <Table.Cell singleLine>Database Modeling</Table.Cell>
                <Table.Cell>
                  Rogério Pessina
                </Table.Cell>
